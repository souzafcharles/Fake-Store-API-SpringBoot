...
class ProductControllerTest {
    ...
    @Test
    void getAll_ShouldReturnNoContent_WhenPageIsEmpty() {
    ...
    @Test
    void getAll_ShouldReturnPagedModel_WhenPageHasData() {
    ...
    @Test
    void topExpensive_ShouldReturnTopProducts() {
    ...
    @Test
    void topCheapest_ShouldReturnTopProducts() {
    ...
    @Test
    void averagePricePerCategory_ShouldReturnMap() {
    ...
    @Test
    void productsByPriceRange_ShouldReturnProducts() {
    ...
    @Test
    void getAll_ShouldCoverAssemblerLambda() {
